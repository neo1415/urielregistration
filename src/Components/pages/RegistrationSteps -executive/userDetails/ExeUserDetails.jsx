...
const ExecUserDetails = ({values, handleChange}) => {
      ...
      <div className='form'>
          <form>
            ...
            <select id="cars" name="gender" size="1"
                ...
                <option  className='gender' value="Gender">Gender</option>
            ...
            <select id="LOE" name="levelOfEducation" size="1"
                ...
                <option className='gender' value="levelOfEducation"></option>
            ...
            <select id="AOE" name="Preffered Area of Expertise" size="1"
                ...
                <option className='gender' value="PrefferedAreaOfExpertise"></option>
...
export default ExecUserDetails